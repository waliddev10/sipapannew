...
@section('title', 'Setting Penandatangan')

@section('content')
<div class="card shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Setting Penandatangan</h6>
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive mt-3">
            <table id="penandatanganTable" class="table table-sm table-bordered table-hover table-striped" width="100%"
                cellspacing="0">
