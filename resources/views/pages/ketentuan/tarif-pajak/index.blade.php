...
<div class="card shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tarif Pajak</h6>
    </div>
    <div class="card-body">
        <a class="btn btn-outline-primary btn-sm" title="Tambah Tarif Pajak" data-toggle="modal"
            data-target="#modalContainer" data-title="Tambah Tarif Pajak" href="{{ route('tarif-pajak.create') }}"><i
                class="fa fa-plus fa-fw"></i>
            Tambah
            Tarif Pajak</a>
        <div class="table-responsive mt-3">
            <table id="tarif-pajakTable" class="table table-sm table-bordered table-hover table-striped" width="100%"
                cellspacing="0">
...
@push('scripts')
<script type="text/javascript">
    tableDokumen = $('#tarif-pajakTable').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
        ajax: '{!! route('tarif-pajak.index') !!}',
        columns: [
